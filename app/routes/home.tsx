...
function Piece({image, alt}: PieceProps) {
  return (
    <img src={image} alt={alt} className="size-10 shadow p-2 rounded bg-base-100 hover:bg-base-200" draggable={false} />
  )
}

function King() {
  return (
    <Piece image='/king.png' alt="king" />
  )
}

function Pawn() {
  return (
    <Piece image='/pawn.png' alt="pawn" />
  )
}
